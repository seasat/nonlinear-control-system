...
class Spacecraft:
    def __init__(self, inertia_tensor: np.matrix, attitude: Attitude, angular_velocity: Attitude) -> None:
        """
        ...
        assert isinstance(angular_velocity, Attitude), "Angular velocity must be an Attitude object"
