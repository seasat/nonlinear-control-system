...
from attitude import Attitude, AngularVelocity, BodyRates
from orbit import Orbit


class Spacecraft:
    def __init__(self, inertia_tensor: np.matrix, attitude: Attitude, angular_velocity: BodyRates, orbit: Orbit) -> None:
        """
    ...
    def set_state(self, attitude: Attitude, angular_velocity: BodyRates) -> None:
        """
        ...
        """
        assert isinstance(attitude, Attitude), "Attitude must be an Attitude object"
        assert isinstance(angular_velocity, BodyRates), "Angular velocity must be an AngularVelocity object"
