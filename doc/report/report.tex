...
The yaw, pitch and roll angles can be calculated from the quaternion as shown in \cref{eqt:quaternion_to_euler}.
\begin{equation} \label{eqt:quaternion_to_euler}
