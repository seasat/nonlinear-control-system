...
It should be noted that any successive rotation is applied to the intermediate frame, resulting from the previous rotation.
...
Any attitude can then be represented by a triplet of roll, pitch and yaw Euler angles (see \cref{eqt:ypr_attitude}).
