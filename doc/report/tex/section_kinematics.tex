...
\begin{equation} \label{eqt:q_rate_state_derivative}
    ...
    \frac{1}{2} A = \frac{1}{2} \begin{bmatrix}
        A_{11} & A_{12} & A_{13} & A_{14} & q_4 & -q_3 & q_2 \\
        A_{21} & A_{22} & A_{23} & A_{24} & q_3 & q_4 & -q_1 \\
        A_{31} & A_{32} & A_{33} & A_{34} & -q_2 & q_1 & q_4 \\
        A_{41} & A_{42} & A_{43} & A_{44} & -q_1 & -q_2 & -q_3
    \end{bmatrix}
\end{equation}
\begin{align*}
    A_{11} &= -\frac{q_1}{q_4} \omega_1 + \frac{q_1}{q_3} \omega_2 - \frac{q_1}{q_2} \omega_3 - \gls{sy:mean_motion} \frac{q_1}{q_3}
    &
    A_{12} &= -\frac{q_2}{q_4} \omega_1+\frac{q_2}{q_3} \omega_2+\omega_3- \gls{sy:mean_motion} \frac{q_2}{q_3}
    \\
...
\end{align*}
\begin{align*}
    A_{21} &= -\frac{q_1}{q_3} \omega_1-\frac{q_1}{q_4} \omega_2-\omega_3- \gls{sy:mean_motion} \frac{q_1}{q_4}
    &
    A_{22} &= -\frac{q_2}{q_3} \omega_1-\frac{q_2}{q_4} \omega_2+\frac{q_2}{q_1} \omega_3- \gls{sy:mean_motion} \frac{q_2}{q_4}
    \\
    A_{23} &= \omega_1-\frac{q_3}{q_4} \omega_2+\frac{q_3^{12}}{q_1} \omega_3- \gls{sy:mean_motion} \frac{q_3}{q_4}
    &
...
\begin{align*}
    ...
    &
    A_{32} &= -\omega_1-\frac{q_2}{q_1} \omega_2-\frac{q_2}{q_4} \omega_3+ \gls{sy:mean_motion} \frac{q_2}{q_1}
    \\
    A_{33} &= \frac{q_3}{q_2} \omega_1-\frac{q_3}{q_1} \omega_2-\frac{q_3}{q_4} \omega_3+ \gls{sy:mean_motion} \frac{q_3}{q_1}
    &
    A_{34} &= \frac{q_4}{q_2} \omega_1-\frac{q_4}{q_1} \omega_2+\omega_3+ \gls{sy:mean_motion} \frac{q_4}{q_1}
\end{align*}
\begin{align*}
    A_{41} &= -\omega_1+\frac{q_1}{q_2} \omega_2+\frac{q_1}{q_3} \omega_3+ \gls{sy:mean_motion} \frac{q_1}{q_2}
    &
    A_{42} &= \frac{q_2}{q_1} \omega_1-\omega_2+\frac{q_2}{q_3} \omega_3- \gls{sy:mean_motion}
    \\
    A_{43} &= \frac{q_3}{q_1} \omega_1+\frac{q_3}{q_2} \omega_2-\omega_3+ \gls{sy:mean_motion} \frac{q_3}{q_2}
    &
    A_{44} &= \frac{q_4}{q_1} \omega_1+\frac{q_4}{q_2} \omega_2+\frac{q_4}{q_3} \omega_3+ \gls{sy:mean_motion} \frac{q_4}{q_2}
\end{align*}
